...
const generatePDF = () => {
    ...
    try {
        ...
        const hideElements = Array.from(document.body.children).filter(el => el !== element && el.nodeName !== 'SCRIPT');
        ...
        // Fix: Properly type check the error before accessing message property
